...
run("systemctl status zerodha_engine.service zerodha_dashboard.service zerodha_commodity.service 2>/dev/null || echo 'Services not installed yet'", "SYSTEMD SERVICES STATUS")
...
run("journalctl -u zerodha_commodity.service -n 50 --no-pager", "ZERODHA COMMODITY SERVICE SYSTEMD LOGS")
